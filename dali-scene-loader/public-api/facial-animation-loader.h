#ifndef DALI_SCENE_LOADER_FACIAL_ANIMATION_LOADER_H
#define DALI_SCENE_LOADER_FACIAL_ANIMATION_LOADER_H
/*
 ...
 */
AnimationDefinition DALI_SCENE_LOADER_API LoadFacialAnimation(const std::string& url);

}
}

#endif // DALI_SCENE_LOADER_FACIAL_ANIMATION_LOADER_H
